...
\begin{quotation}
    ...
    In this thesis, we provide an implementation of a Grapple model checker, a method for estimating unique states visited, an extension to the default Grapple search strategy called \emph{start overs} that can reach deeper states, and a visualization technique for breadth-first search frontiers.
    ...
    Our series of experiment on low-connectivity models shows promising characteristics that can potentially be used to identify low-connectivity models.
\end{quotation}
...
% As paths leading to a violation are not continued, the maximum is in practice much lower.
