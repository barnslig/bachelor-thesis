#ifndef HYPERLOGLOG_CONSTANTS_CUH_
#define HYPERLOGLOG_CONSTANTS_CUH_

constexpr unsigned int kHllHashSeed = 313;

constexpr double switchThreshold[15] = {10, 20, 40, 80, 220, 400, 900, 1800, 3100, 6500,
                                        11500, 20000, 50000, 120000, 350000};

constexpr double *rawEstimateData[] = {
    // precision 4
    (double[]){
        11,
        11.717,
...
#endif // HYPERLOGLOG_CONSTANTS_CUH_
